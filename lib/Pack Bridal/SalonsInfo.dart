...
import 'package:my_madamn_app/Pack%20Bridal/ServicesList.dart';
...
class SalonsInfo extends StatefulWidget {
  final stylist;

  const SalonsInfo(this.stylist);

  @override
  State<SalonsInfo> createState() => _SalonsInfoState();
}

class _SalonsInfoState extends State<SalonsInfo> {
                      ...
                      child: Container(
                        ...
                        child: Column(
                          ...
                          child: SizedBox(
                            ...
                            child: ourButton(
                              color: BbRed,
                              title:"Offres des services",
                              onPress: () {
                    Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => ServicesList(stylistData)));
                  },
                            ),
                          ),
                        ),
